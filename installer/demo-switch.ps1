...
#   irm https://raw.githubusercontent.com/spondanai/bagidea-office/feat/macos-updates/installer/demo-switch.ps1 | iex
#
...
param(
  ...
  [string]$Branch = $(if ($env:BAGIDEA_BRANCH) { $env:BAGIDEA_BRANCH } else { "feat/macos-updates" })
)
