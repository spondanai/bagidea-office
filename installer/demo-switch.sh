...
#   curl -fsSL https://raw.githubusercontent.com/spondanai/bagidea-office/feat/macos-updates/installer/demo-switch.sh | bash
#
...
BRANCH="${BAGIDEA_BRANCH:-feat/macos-updates}"
